...
\begin{center}
\includegraphics[width=0.5\textwidth]{../data/ncrystal_bc_yp_breakdown_be.pdf}
\end{center}
...
\labfig{phiofs}
\begin{center}
\includegraphics[width=0.5\textwidth]{generated/phi_of_s.pdf}
\end{center}
...
\labfig{fofeta}
\begin{center}
\includegraphics[width=0.5\textwidth]{generated/f_of_eta.pdf}
\end{center}
\caption{Bla.} % NB \protect\cite{...} is required in floating figures
\end{figure}
\begin{align}
...
\labfig{integrandgP}
\begin{center}
\includegraphics[width=0.5\textwidth]{generated/integrand_gP_of_eta_g.pdf}
\end{center}
\caption{Bla.} % NB \protect\cite{...} is required in floating figures
\end{figure}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{generated/integrand_gPgGgLgF_of_eta_g.pdf}
\end{center}
