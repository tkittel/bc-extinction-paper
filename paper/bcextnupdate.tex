...
\begin{align}
  y_p(\theta,x) = \frac{3}{4\pi}\int_{0}^{\infty} f(\eta)\varphi\left(\theta,xf(\eta)\right)d\eta
  \labeqn{ypintegral}
\end{align}
...
\begin{align}
  ...
  y_s^G(\theta,x) = \frac{3}{2\pi}\int_{0}^{\infty} f_G(\eta)\varphi\left(\theta,X_Gf_G(\eta)\right)d\eta
  \labeqn{ysintegralG}
\end{align}
\begin{align}
  %Note integration limit from 0..inf, so have multiplied factor in front by 2!!
  y_s^L(\theta,x) = \frac{2}{\pi}\int_{0}^{\infty} f_L(\eta)\varphi\left(\theta,\frac{4}{3}X_Lf_L(\eta)\right)d\eta
  \labeqn{ysintegralL}
\end{align}
\begin{align}
  %Note integration limit from 0..inf, so have multiplied factor in front by 2!!
  y_s^F(\theta,x) = \frac{3}{2\pi}\int_{0}^{\infty} f_F(\eta)\varphi\left(\theta,X_Ff_F(\eta)\right)d\eta
  \labeqn{ysintegralF}
\end{align}
