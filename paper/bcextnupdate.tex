...
\title{Revisiting Becker-Coppens (1974): Updated Recipes for Estimating Primary Extinction Factors in Spherical Crystallites}
...
estimating primary extinction factors in spherical crystallites is provided,
...
Becker-Coppens (1974), for the estimation of primary extinction factors in a
perfect spherical crystallite. In the original publication, these extinction
factors were evaluated numerically from a complicated integral, and simplified
...
original recipes suffers from numerical break-down in back-scattering scenarios
($\theta_\texttt{Bragg}\gtrsim50^\circ$). Using modern computing capabilities,
the numerical evaluation of the original integral is revisited, and updated
recipes are provided which can be used also for back-scattering and strong
extinction scenarios. In order to facilitate easy adoption by the community, the
new recipes are compared to the old, and two new recipes are provided: a
minimalistic update of the 4 free parameters in the old recipes, and a more
complicated and precise analytical form with 21 free parameters. Both new
recipes solve the issues of numerical break-down.
\end{abstract}

\keywords{primary extinction; bragg diffraction; neutron scattering; X-ray diffraction}
