...
recipe for $y_P(x,\theta)$ is shown in \label{alg:yfct_primary}. All other
...
In \refalgrange{alg:yfct_scndgauss}{alg:yfct_scndfresnel} are shown the
...
\refalgrange{alg:yfct_primary_lux}{alg:yfct_scndfresnel_lux} show the ``luxury''
